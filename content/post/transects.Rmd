...
```{r cape_point_trans, fig.cap="Alongshore and shore-normal transects around Cape Point and False Bay, South Africa."}
...
```{r south_africa_trans, fig.height=6, fig.width=9, fig.cap="Alongshore and shore-normal transects around all of South Africa."}
...
```{r baja_pen_trans, fig.cap="Alongshore and shore-normal transects around the Baja Peninsula."}
...
```{r bohai_sea_trans, fig.cap="Alongshore and shore-normal transects within the Bohai Sea."}
