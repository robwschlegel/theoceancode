...
pride <- data_frame(txt = prideprejudice, 
                    src = "pride")
# Quran
quran <- data_frame(txt = as.character(pdf_text("../../static/data/EQuran.pdf")),
                    src = "quran")
# Bible
bible <- data_frame(txt = as.character(pdf_text("../../static/data/KJBNew.pdf")),
                    src = "bible")
# Torah
torah <- data_frame(txt = as.character(pdf_text("../../static/data/Torah.pdf")), 
                    src = "torah")
# Bhagavad Gita
gita <- data_frame(txt = as.character(pdf_text("../../static/data/BGita.pdf")), 
                    src = "gita")
# Book of the dead
