...
It has been determined that some of the layers in the current version of the Bio-Oracle product appear to have very large issues. Specifically there are many layers where the minimum values are greater than the maximum values. It is unclear how this could be possible, so in the following text and code we will look into how we go about investigating these data layers and we will discuss which layers are fine, and which are not.
...
The next code chunk goes through all of the newer layers and where possible the future projections, too. Note that many layers have four different depth options. The surface (ss), the min (bdmin), the mean (bdmean), and the max (bdmax) depths present at each pixel. Another distinction to make for the following tests is that there are min/max values for each layer, which take the absolute min/max recorded at a pixel. And then there are the long-term min/max values, which are the average annual min/max recorded over the length of the available data. The long-term min/max values are more representative of the climatological means within an area, and the absolute min/max are representative of the most extreme events that may occur in an area. Generally one is going to be more interested in the long-term values for normal species distribution modelling (SDM) applications.
...
BO_test("BO2_chloltX_ss", scenario = "RCP85", year = 2050) # Same issues as non-long-term layer
...
BO_test("BO2_curvelX_ss", scenario = "RCP85", year = 2100)
...
# Ice thickness
BO_test("BO2_icethickX_ss")
BO_test("BO2_icethickX_ss", scenario = "RCP85", year = 2050)
BO_test("BO2_icethickX_ss", scenario = "RCP85", year = 2100)

# Ice thickness long-term
BO_test("BO2_icethickltX_ss")
BO_test("BO2_icethickltX_ss", scenario = "RCP85", year = 2050)
BO_test("BO2_icethickltX_ss", scenario = "RCP85", year = 2100)

# Iron
BO_test("BO2_ironX_bdmax")
BO_test("BO2_ironX_bdmean")
BO_test("BO2_ironX_bdmin")
BO_test("BO2_ironX_ss")

# Iron long-term
BO_test("BO2_ironltX_bdmax")
BO_test("BO2_ironltX_bdmean")
BO_test("BO2_ironltX_bdmin")
BO_test("BO2_ironltX_ss")

# Light at bottom
BO_test("BO2_lightbotX_bdmax")
BO_test("BO2_lightbotX_bdmean")
BO_test("BO2_lightbotX_bdmin")

# Light at bottom long-term
BO_test("BO2_lightbotltX_bdmax")
BO_test("BO2_lightbotltX_bdmean")
BO_test("BO2_lightbotltX_bdmin")

# Nitrate
BO_test("BO2_nitratemax_bdmax")
BO_test("BO2_nitratemax_bdmean")
BO_test("BO2_nitratemax_bdmin")
BO_test("BO2_nitratemax_sss")

# Nitrate long-term
BO_test("BO2_nitrateltmax_bdmax")
BO_test("BO2_nitrateltmax_bdmean")
BO_test("BO2_nitrateltmax_bdmin")
BO_test("BO2_nitrateltmax_sss")

# Phosphate absolute
BO_test("BO2_phosphateX_bdmax")
BO_test("BO2_phosphateX_bdmean")
BO_test("BO2_phosphateX_bdmin")
BO_test("BO2_phosphateX_ss")

# Phosphate long-term
BO_test("BO2_phosphateltX_bdmax")
BO_test("BO2_phosphateltX_bdmean")
BO_test("BO2_phosphateltX_bdmin")
BO_test("BO2_phosphateltX_ss")

# Primary production absolute
BO_test("BO2_ppmax_bdmax")
BO_test("BO2_ppmax_bdmean")
BO_test("BO2_ppmax_bdmin")
BO_test("BO2_ppmax_ss")

# Primary production long-term
BO_test("BO2_ppltmax_bdmax")
BO_test("BO2_ppltmax_bdmean")
BO_test("BO2_ppltmax_bdmin")
BO_test("BO2_ppltmax_ss")

# Salinity absolute
BO_test("BO2_salinityX_bdmax")
BO_test("BO2_salinityX_bdmax", scenario = "RCP85", year = 2050)
BO_test("BO2_salinityX_bdmax", scenario = "RCP85", year = 2100)
BO_test("BO2_salinityX_bdmean")
BO_test("BO2_salinityX_bdmean", scenario = "RCP85", year = 2050)
BO_test("BO2_salinityX_bdmean", scenario = "RCP85", year = 2100)
BO_test("BO2_salinityX_bdmin")
BO_test("BO2_salinityX_bdmin", scenario = "RCP85", year = 2050)
BO_test("BO2_salinityX_bdmin", scenario = "RCP85", year = 2100)
BO_test("BO2_salinityX_ss")
BO_test("BO2_salinityX_ss", scenario = "RCP85", year = 2050)
BO_test("BO2_salinityX_ss", scenario = "RCP85", year = 2100)

# Salinity long-term
BO_test("BO2_salinityltX_bdmax")
BO_test("BO2_salinityltX_bdmax", scenario = "RCP85", year = 2050)
BO_test("BO2_salinityltX_bdmax", scenario = "RCP85", year = 2100)
BO_test("BO2_salinityltX_bdmean")
BO_test("BO2_salinityltX_bdmean", scenario = "RCP85", year = 2050)
BO_test("BO2_salinityltX_bdmean", scenario = "RCP85", year = 2100)
BO_test("BO2_salinityltX_bdmin")
BO_test("BO2_salinityltX_bdmin", scenario = "RCP85", year = 2050)
BO_test("BO2_salinityltX_bdmin", scenario = "RCP85", year = 2100)
BO_test("BO2_salinityltX_ss")
BO_test("BO2_salinityltX_ss", scenario = "RCP85", year = 2050)
BO_test("BO2_salinityltX_ss", scenario = "RCP85", year = 2100)

# Silicate absolute
BO_test("BO2_silicatemax_bdmax")
BO_test("BO2_silicatemax_bdmean")
BO_test("BO2_silicatemax_bdmin")
BO_test("BO2_silicatemax_ss")

# Silicate long-term
BO_test("BO2_silicateltmax_bdmax")
BO_test("BO2_silicateltmax_bdmean")
BO_test("BO2_silicateltmax_bdmin")
BO_test("BO2_silicateltmax_ss")

# Temperature absolute
BO_test("BO2_tempmax_bdmax")
BO_test("BO2_tempmax_bdmax", scenario = "RCP85", year = 2050)
BO_test("BO2_tempmax_bdmax", scenario = "RCP85", year = 2100)
BO_test("BO2_tempmax_bdmean")
BO_test("BO2_tempmax_bdmean", scenario = "RCP85", year = 2050)
BO_test("BO2_tempmax_bdmean", scenario = "RCP85", year = 2100)
BO_test("BO2_tempmax_bdmin")
BO_test("BO2_tempmax_bdmin", scenario = "RCP85", year = 2050)
BO_test("BO2_tempmax_bdmin", scenario = "RCP85", year = 2100)
BO_test("BO2_tempmax_ss")
BO_test("BO2_tempmax_ss", scenario = "RCP85", year = 2050)
BO_test("BO2_tempmax_ss", scenario = "RCP85", year = 2100)

# Temperature long-term
BO_test("BO2_templtmax_bdmax")
BO_test("BO2_templtmax_bdmax", scenario = "RCP85", year = 2050)
BO_test("BO2_templtmax_bdmax", scenario = "RCP85", year = 2100)
BO_test("BO2_templtmax_bdmean")
BO_test("BO2_templtmax_bdmean", scenario = "RCP85", year = 2050)
BO_test("BO2_templtmax_bdmean", scenario = "RCP85", year = 2100)
BO_test("BO2_templtmax_bdmin")
BO_test("BO2_templtmax_bdmin", scenario = "RCP85", year = 2050)
BO_test("BO2_templtmax_bdmin", scenario = "RCP85", year = 2100)
BO_test("BO2_templtmax_ss")
BO_test("BO2_templtmax_ss", scenario = "RCP85", year = 2050)
BO_test("BO2_templtmax_ss", scenario = "RCP85", year = 2100)
```

This is not meant to be exhaustive, but does represent the majority of the data offered by Bio-Oracle. I had hypothesised that the three different depth options per pixel would have been related to the issues in the data assimilation but it does not appear to be the case. I've concluded this because Whenever a depth layer has issues, those errors appear to be very similar across the three different depth layers.

## Discussion

It appears that all of the layers that have issues are physical oceanography layers. Specifically it is my understanding that these layers would have been adapted from the GLORYS reanalysis product. Therefore the next logical step in understanding this issue would be to investigate the GLORYS data. But even if there were issues in the GLORYS product, which I doubt, it would not explain how the data layers here could have minimum values being reported as greater than the maximum values in the distribution. The only thing that makes any sense is that the data layers are created independently of each other. But why?

Without being able to see the pipeline code myself all I can do is ponder, which isn't terribly useful. So to wrap things up I'll provide two tables; the layers with no issues, and those with issues. I would strongly recommend not using any data layers that did not pass the tests in this analysis until the curators of the Bio-Oracle data address these issues in a new release.

Layers with no issues (fine for use):
- All of the older BO layers are fine
- Carbon phytoplankton biomass absolute and long-term at all depths
- Chlorophyll absolute and long-term at all depths for present day projections
